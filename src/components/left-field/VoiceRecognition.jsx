		...
		if (this.props.recognitionRecord) {
			this.props.recognitionRecord.map((record) => {
				if (record.userID == this.props.localUserID) {
					RecognitionRecord.push(<div className="myself-message">
						<div className="myself-infro">
							<img className="image" alt="" src="./img/animal1.jpg" />
							<div className="name">
								{
					...
					RecognitionRecord.push(<div className="others-message">
						<div className="others-infro">
							<img className="image" alt="" src="./img/animal2.jpg" />
							<div className="name">
								{

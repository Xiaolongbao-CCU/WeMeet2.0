...
class SixHatDetail extends React.Component {
  ...
  onClick_start() {
    const numberOfParticipant = this.props.participantList.length;
    const arr = [0, 1, 2, 3, 4, 5];
    const final = [];
    for (let i = 0; i < numberOfParticipant; i += 1) {
      const randomNumber = Math.floor((Math.random() * (6 - i)));
      ...
      case 'teachingPage':
        SixHatPage = (
          <div className="teachingPage">
            <button className="exit" onClick={() => { this.props.dispatch(setSixhatDetailClose()); }} />
            <div className="title">
        ...
        SixHatPage = (
          <div className="startPage">
            ...
            <div className="left-field">
              <img className="img" alt=""　src="./img/sixhat_img.png" />
              <div className="text">

        ...
        SixHatPage = (
          <div className="teachingPage">
            ...
            <div className="teachingText">
              <ul>
                <li id="fadeIn">第一個階段：請確立好要解決的問題，就像確定目標畫好地圖。</li>
                <li id="fadeIn1">第二個階段：每一種顏色的帽子代表一種思維，當你戴上其中一頂時，你就只能採用該種思維模式來考慮問題。</li>
              </ul>
            </div>
            <div className="teachingSixhat">
              <img className="teachingImg" id="fadeIn2" src="./img/teaching_sixhat.png" />
            </div>
            <div className="bottom-field">
              <div className="button">開始遊戲</div>
              <div className="button" onClick={this.onClick_TogglePreviousPage} >回上一頁</div>
            </div>
          </div>
        )
        break;
        ...
        SixHatPage = (
          <div className="startPage">
            ...
            <div className="left-field">
              ...
              <div className="text">遊戲簡介：以六種顏色的帽子代表六種不同思考模式的創造思考技法，幫助團隊進行全方位的思考以及評估。</div>
            </div>
            ...
            <div className="bottom-field">
              <div className="button">開始遊戲</div>
              <div className="button" onClick={this.onClick_ToggleNextPage} >看教學</div>
            </div>
          </div>
        )
        break;
